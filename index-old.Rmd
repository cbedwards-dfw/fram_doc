...
mermaid("
flowchart TD
    A[Cohort] -->|Natural Mortality| B(Preterminal fisheries)
    B --> |Preterminal Fishery Mortalities| C{Maturation}
    C -->|Mature Cohort| D[Terminal Fisheries]
    C -->|Immature cohort. Increment timestep| A
    D --> |Terminal Fishery Mortality| E(Escapement)
    ")
```
